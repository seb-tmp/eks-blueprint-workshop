...
#terraform destroy -target="module.eks_cluster.gitops_bridge_bootstrap" -auto-approve || (echo "error deleting module.eks_cluster.gitops_bridge_bootstrap" && exit -1)
terraform destroy -target="module.eks_cluster.module.eks_blueprints_addons" -auto-approve || (echo "error deleting module.eks_cluster.module.kubernetes_addons" && exit -1)
